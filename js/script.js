...
const playMusic = (track, pause = false) => {
    ...
    // audio.play()
    currentSong.src = `/${currFolder}/` + track  // it will send request to songs folder to get track(means it will become something like this https://127.0.0.1/3000/songs/track) then it will give me that track's link from songs folder and put into currentSong.src means in Audio object's src to play
    if (!pause) {
        currentSong.play();
